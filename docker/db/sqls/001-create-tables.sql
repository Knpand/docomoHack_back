...
(id int not null auto_increment primary key, userid varchar(100) not null unique, password varchar(128) not null, name varchar(100))DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
